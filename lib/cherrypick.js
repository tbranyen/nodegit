...
/**
 * Cherrypicks the given commit against "our" commit, producing an index that reflects the result of
 * the cherrypick. The index is not backed by a repo.
 *
 ...
 * @param {int}          mainline           The parent of the revert commit (1 or 2) if it's a
 *                                          merge, 0 otherwise.
