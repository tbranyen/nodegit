 ...
 * @returns {number|Index} An error code for an unsuccesful rebase or an index for
 ...
 *                                      with
 * @returns {Oid|Index}  A commit id for a succesful merge or an index for a
 ...
 * @param {Array} parents
 * @returns {String} The content of the commit object
 *                  as a string
 */
