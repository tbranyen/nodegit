...
Tag.createBuffer = function (repo, tagName, target, tagger, message) {
  return NodeGit.Object.lookup(repo, target, NodeGit.Object.TYPE.ANY).then((object) => {
 ...
 * @param {number}     force
 * @param {Function}   signingCallback  Takes a string and returns a string representing the signed
 *                                      message.
 * @returns {Oid}
 * @async
 */
