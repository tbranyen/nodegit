 ...
 * @param {Commit | Tag} target     The committish which content will be used to reset the content
 *                                  of the index.
 ...
 *                                     This object must belong to the given `repo` and can either be
 *                                     a git_commit or a git_tag. When a git_tag is being passed, it
 *                                     should be dereferencable to a git_commit which oid will be
 ...
 *                                     The checkout_strategy field will be overridden (based on
 *                                     reset_type). This parameter can be used to propagate notify
 ...
 * tree to match.
 *
 * This behaves like reset but takes an annotated commit, which lets you specify which extended sha
 * syntax string was specified by a user, allowing for more exact reflog messages.
 *
