...
var baseSignature = nodegit.Signature.now('Peaceful Bob', 'justchill@bob.net');
var ourSignature = nodegit.Signature.now('Big Bob', 'impressive@bob.net');
var theirSignature = nodegit.Signature.now('Small Bob', 'underestimated@bob.net');
