...
var ourSignature = nodegit.Signature.now('Ron Paul', 'RonPaul@TollRoadsRBest.info');
var theirSignature = nodegit.Signature.now('Greg Abbott', 'Gregggg@IllTollYourFace.us');
