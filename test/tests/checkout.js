...
describe('Checkout', function () {
  ...
  it('can checkout the head', function () {
    ...
    return Checkout.head(test.repository).then(function (_blob) {
  ...
  it('can checkout an index with conflicts', function () {
    ...
    return test.repository
      ...
      .then((oid) => {
        assert.equal(oid.toString(), '85135ab398976a4d5be6a8704297a45f2b1e7ab2');

        return test.repository.createCommit(
          'refs/heads/' + testBranchName,
          signature,
          signature,
