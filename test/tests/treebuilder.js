...
describe('TreeBuilder', function () {
  ...
  beforeEach(function () {
    ...
    return Git.Repository.open(reposPath).then(function (repo) {
      test.repo = repo;
    });
  });
  ...
  it('Can create a treebuilder from the latest commit tree', function () {
    ...
    return (
      test.repo
        ...
        .then(function (tree) {
          return Git.Treebuilder.create(test.repo, tree);
        })
      ...
      test.repo
        ...
        .then(function (rootTreeBuilder) {
          ...
          return Git.Treebuilder.create(test.repo, null)
            ...
            .then(function (oid) {
              return rootTreeBuilder.insert('mynewfolder', oid, Git.TreeEntry.FILEMODE.TREE);
            });
        })
  ...
  it('does not leak inserts', function () {
    ...
    return leakTest(Git.TreeEntry, function () {
      return Git.Treebuilder.create(test.repo, null).then(function (builder) {
