...
describe('TreeEntry', function () {
  ...
  it('provides the full path when the entry came from a tree', function () {
    ...
    return this.commit.getTree().then(testTree);
  });

  it('provides the blob representation of the entry', function () {
    return this.commit
      .getEntry('test/raw-commit.js')
      .then(function (entry) {
  ...
  it('can determine if an entry is a submodule', function () {
    ...
    return repo.getCommit('878ef6efbc5f85c4f63aeedf41addc262a621308').then(function (commit) {
      return commit.getEntry('vendor/libgit2').then(function (entry) {
  ...
  it('does not leak', function () {
    ...
    return leakTest(NodeGit.TreeEntry, function () {
      return test.commit.getTree().then(function (tree) {
