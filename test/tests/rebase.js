...
describe('Rebase', function () {
  ...
  beforeEach(function () {
    var test = this;
    return RepoUtils.createRepository(repoPath).then(function (repo) {
  ...
  it('can cleanly fast-forward via rebase', function () {
    ...
    return (
      fse
        .writeFile(path.join(repository.workdir(), ourFileName), ourFileContent)
        ...
        .then(function (commitOid) {
          ...
          return repository
            ...
            .then(function () {
              return repository.createBranch(ourBranchName, commitOid).then(function (_branch) {
        ...
        .then(function (annotatedCommits) {
          ...
          assert.equal(
            ourAnnotatedCommit.id().toString(),
            '91a183f87842ebb7a9b08dad8bc2473985796844'
          );
          assert.equal(
            theirAnnotatedCommit.id().toString(),
  ...
  it('can cleanly rebase a branch in-memory', function () {
    ...
    return (
      fse
        .writeFile(path.join(repository.workdir(), baseFileName), baseFileContent)
        // Load up the repository index and make our initial commit to HEAD
        .then(function () {
        ...
        .then(function (commit) {
          ...
          assert.equal(commit.id().toString(), 'e7f37ee070837052937e24ad8ba66f6d83ae7941');

          // Lookup the new commit
          return NodeGit.Commit.lookup(repository, 'b937100ee0ea17ef20525306763505a7fe2be29e');
        })
        .then(function (commit) {
    ...
    return (
      fse
        ...
        .then(function (annotatedCommits) {
          ...
          return NodeGit.Rebase.init(repository, ourAnnotatedCommit, theirAnnotatedCommit, null);
        })
        .then(function (newRebase) {
          rebase = newRebase;
  ...
  it('can rebase 2 branches with conflicts on a single file', function () {
    ...
    return fse
      .writeFile(path.join(repository.workdir(), fileName), baseFileContent)
      .then(function () {
      ...
      .then(function () {
        return fse
          .readFile(path.join(repository.workdir(), fileName), 'utf8')
    ...
    return (
      fse
        ...
        .then(function (commitOid) {
          ...
          return repository.getBranchCommit('HEAD').then(function (commit) {
    ...
    function () {
      ...
      return (
        fse
          ...
          .then(function () {
            return repository.checkoutBranch(ourBranch, {
          ...
          .then(function () {
            return repository.checkoutBranch(theirBranch, {
              checkoutStrategy: Checkout.STRATEGY.FORCE,
            });
          })
          .then(function () {
          ...
          .then(function (oid) {
            assert.equal(oid.toString(), 'c242b53f2c9446544cf9bdac7e8ed6ce583226cb');

            return repository.createCommit(
              theirBranch.name(),
              theirOtherSignature,
              theirOtherSignature,
              'they made another commit',
              oid,
              [theirCommit]
            );
          })
          .then(function (commitOid) {
            assert.equal(commitOid.toString(), '8fa0ce25a2accf464b004ddeeb63add7b816b627');
          })
          .then(function () {
            return Promise.all([
              repository.getReference(ourBranchName),
          ...
          .then(function (commit) {
            assert.equal(commit.id().toString(), '8fa0ce25a2accf464b004ddeeb63add7b816b627');
          })
      );
    }
  );
        ...
        .then(function () {
          return repository.rebaseBranches(
            ...
            function (rebaseMetadata) {
              ...
              assert.deepEqual(rebaseMetadata.rewritten, [
  ...
  it('can rebase with conflicts using the convenience methods', function () {
    ...
    return fse
      ...
      .then(function () {
        return repository
          .rebaseBranches(ourBranchName, theirBranchName, null, ourSignature)
          .then(function (commit) {
            assert.fail(
              commit,
              undefined,
    ...
    it('can sign commits during the rebase', function () {
      ...
      return (
        fse
          ...
          .then(function (commitOid) {
            assert.equal(commitOid.toString(), '24250fe6bd8a782ec1aaca8b2c9a2456a90517ed');
          ...
          .then(function (commit) {
            // verify that the "ours" branch has moved to the correct place
            assert.equal(commit.id().toString(), '24250fe6bd8a782ec1aaca8b2c9a2456a90517ed');
          ...
          .then(function ([parent, { signature }]) {
            // verify that we are on top of "their commit"
            assert.equal(parent.id().toString(), 'e9ebd92f2f4778baf6fa8e92f0c68642f931a554');
  ...
  it('will not throw on patch already applied errors', function () {
    ...
    return (
      fse
        ...
        .then(function (oid) {
          assert.equal(oid.toString(), '6f14d06b24fa8ea26f511dd8a94a003fd37eadc5');
          ...
          return repository
            ...
            .then(function (commitOid) {
              assert.equal(commitOid.toString(), 'c4cc225184b9c9682cb48294358d9d65f8ec42c7');
              return repository.createCommit(
                ourBranch.name(),
                ourSignature,
                ourSignature,
        ...
        .then(function (commitOid) {
          assert.equal(commitOid.toString(), '5814ffa17b8a677191d89d5372f1e46d50d976ae');
        ...
        .then(function (annotatedCommits) {
          ...
          return NodeGit.Rebase.init(repository, ourAnnotatedCommit, theirAnnotatedCommit);
        })
        .then(function (newRebase) {
          rebase = newRebase;
        ...
        .then(function (rebaseOperation) {
          assert.equal(rebaseOperation.type(), NodeGit.RebaseOperation.REBASE_OPERATION.PICK);
          assert.equal(rebaseOperation.id().toString(), '5814ffa17b8a677191d89d5372f1e46d50d976ae');
